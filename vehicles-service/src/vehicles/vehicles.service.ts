...
export class VehiclesService {
    ...
    async createVehicle(createVehicleInput: CreateVehicleInput): Promise<Vehicule> {
    ...
    async addPosition(createPositionInput: CreatePositionInput): Promise<VehiclePosition> {
    ...
    async updateVehicle(id: number, updateVehicleInput: UpdateVehicleInput): Promise<Vehicule> {
    ...
    async updateStatus(updateStatusInput: UpdateVehicleStatusInput): Promise<Vehicule> {
