...
export class IncidentsService {
    ...
    async createIncident(createIncidentInput: CreateIncidentInput, authorId: number): Promise<Incident> {
    ...
    async updateIncidentStatus(updateInput: UpdateIncidentStatusInput): Promise<Incident> {
